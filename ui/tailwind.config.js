  ...
  theme: {
    extend: {
      ...
      backgroundImage: (theme) => ({
        ...
        "success-gradient": `linear-gradient(to right, ${theme(
          "colors.success.500"
        )}, ${theme("colors.success.700")})`,
        "info-gradient": `linear-gradient(to right, ${theme(
          "colors.info.500"
        )}, ${theme("colors.info.700")})`,
        "dark-gradient": `linear-gradient(to right, ${theme(
          "colors.dark"
        )}, ${theme("colors.black")})`,
        "error-gradient": `linear-gradient(to right, ${theme(
          "colors.error.500"
