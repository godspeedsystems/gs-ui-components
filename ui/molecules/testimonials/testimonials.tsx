  ...
  testimonials = [
    {
      ...
      answer:
        "Xultions is a platform designed to help you build beautiful landing pages with ease, using modern UI components and best practices.",
      author: {
        name: "Alex Carter",
    ...
    },
    {
      ...
      answer:
        "Simply sign up for a free trial, choose a template, and start customizing your landing page. No coding skills required!",
      author: {
        name: "Sara Lee",
        role: "UI Engineer, Xultions",
        avatar: images.image5,
      },
      rating: 5,
    },
    {
      ...
      answer:
        "Yes, we offer a free plan with basic features so you can try out Xultions before upgrading to a premium plan.",
      author: {
        name: "John Doe",
        role: "Frontend Dev, Xultions",
        avatar: images.image6,
      },
      rating: 5,
    },
    {
      ...
      answer:
        "Absolutely! You can connect your custom domain to your landing page in just a few clicks from your dashboard.",
      author: {
        name: "Emily Stone",
        role: "Support Lead, Xultions",
        avatar: images.image7,
      },
      rating: 5,
    },
    {
      ...
      answer:
        "We take security seriously. All your data is encrypted and stored securely using industry best practices.",
      author: {
        name: "Michael Fox",
        role: "Security Lead, Xultions",
        avatar: images.image8,
      },
      rating: 5,
    },
    {
