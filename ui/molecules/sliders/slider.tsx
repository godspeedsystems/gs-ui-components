...
const Slider: React.FC = () => {
  const slides: SlideItem[] = [
    { id: 0, image: images.image4, title: "Ulli Top", price: 145.0 },
    { id: 1, image: images.image5, title: "Hao Earrings", price: 25.0 },
    { id: 2, image: images.image7, title: "Diam Gauri Dress", price: 185.0 },
    {
      id: 3,
      image:
      ...
      <div className="w-full min-h-screen max-w-full mx-auto bg-[#f7f5f2] flex flex-col">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 text-base">
            We aren't traditional, but we honor traditions
          </p>
        </div>
